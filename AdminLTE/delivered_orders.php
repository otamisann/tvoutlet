...
<title>tvOutlet | Delivered</title>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="deliver.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="delivered_orders.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Delivered Products</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped" style="width: 100%;">
                                            ...
                                            <tbody>
                                                <!-- php -->
                                                <?php
                                                $sql_package = "SELECT * FROM `mainordertbl` WHERE Status = 4;";
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        ?>
                                                        <p class="text-left">Name: <?php echo $row_ord_name['firstname']." ".$row_ord_name['lastname']; ?><br>Phone: <?php echo $row_package['ContactNum']; ?><br>Shipping Address: <br><?php echo $row_package['ShipAddress']; ?></p>
                                                    </td>
                                                    <!-- products -->
                                                    <td>
                                                    <?php
                                                        $sql_ord_prod = "SELECT * FROM `mainordertbl` JOIN ordertbl ON mainordertbl.MainOrderID = ordertbl.MainOrderID WHERE Status = 4 AND ordertbl.MainOrderID = $row_package[MainOrderID];";
                                                    ...
                                                    $mydate2 = strtotime($row_package['DeliveredOn']);
                                                    ...
                                                    <td>Date:<br> <strong><?php echo date('F j, Y', $mydate3); ?></strong><br>Time:<br> <strong><?php echo date('h:i:s A', $mydate3); ?></strong></td>

                                                    <td>Date:<br><strong><?php echo date('F j, Y', $mydate2); ?></strong><br>Time:<br> <strong><?php echo date('h:i:s A', $mydate2); ?></strong></td>
                                                </tr>
                                                <?php endwhile; ?>
                                            </tbody>
                                        </table>
