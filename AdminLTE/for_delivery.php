...
<title>tvOutlet | For Delivery</title>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="packaging.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="for_delivery.php" class="nav-link active">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php echo $row_ord_prod['TVName']; ?> <p class="text-muted">Model: <?php echo $row_ord_prod['TVModel']; ?><br>Brand: <?php echo $row_ord_prod['Brand']; ?></p>
                                                        <?php endwhile; ?>
                                                        Packed Date:<br><strong><?php echo date('F j, Y h:i:s A', $mydate3); ?></strong>
                                                    </td>
                                                    <!-- products -->
