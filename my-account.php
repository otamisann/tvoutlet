                        ...
                        <div class="col-md-9">
                            <div class="message-box box-shadow white-bg">
                                <form id="contact-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="blog-section-title border-left mb-30">Profile</h4>
                                            <p>Manage your account</p>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="k" class="text-muted">First Name</label>
                                            <input type="text" name="firstname" value="<?php echo $row_profile['firstname']; ?>" required="">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="k" class="text-muted">Middle Name</label>
                                            <input type="text" name="middlename" value="<?php echo $row_profile['middlename']; ?>">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="k" class="text-muted">Last Name</label>
                                            <input type="text" name="lastname" value="<?php echo $row_profile['lastname']; ?>" required="">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="k" class="text-muted">Email Address</label>
                                            <input type="text" name="emailaddress" value="<?php echo $row_profile['emailaddress']; ?>" required="">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="k" class="text-muted">Phone Number</label>
                                            <input type="text" name="phonenumber" value="<?php echo $row_profile['phonenumber']; ?>" required="">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="k" class="text-muted">Gender</label>
                                            <select class="custom-select" required name="gender">
                                                <!-- <option value="defalt">Choose</option> -->
                                                <option value="Male" <?php if ($row_profile['gender'] == 'Male') echo "selected='selected'"; ?>>Male</option>
                                                <option value="Female" <?php if ($row_profile['gender'] == 'Female') echo "selected='selected'"; ?>>Female</option>
                                                <option value="Other" <?php if ($row_profile['gender'] == 'Other') echo "selected='selected'"; ?>>Other</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="k" class="text-muted">Date of Birth</label>
                                            <input type="date" name="birthday" value="<?php echo $row_profile['birthday']; ?>" required>
                                        </div>
                                        <div class="col-md-12">
                                            <button class="submit-btn-1 mt-1 btn-hover-1 f-right" type="submit" name="save_profile">Save
                                                Profile</button>
                                        </div>
                                    </div>
                                </form>
