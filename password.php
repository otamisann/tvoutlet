...
<body>
    ...
    <div class="wrapper">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="breadcrumbs-inner">
                                <h1 class="breadcrumbs-title">Password</h1>
        ...
        if (isset($_POST['update_password'])) {
            ...
            $id = $_SESSION['user_id'];
            // current pass
            $sql_current = "SELECT password FROM usertbl WHERE userID = $id;";
            $res_current = mysqli_query($conn, $sql_current);
            $row_current = mysqli_fetch_assoc($res_current);

            if ($row_current['password'] != $current_pass) { ?>
                <script>
                    Swal.fire({
                        icon: 'error',
                        title: 'Invalid password',
                        text: 'Your current password doesn`t match our records',
                        confirmButtonText: 'Try again',
                        confirmButtonColor: '#FF7F00'
                    })
                </script>
            <?php } elseif ($new_pass != $confirm_pass) { ?>
                <script>
                    Swal.fire({
                        icon: 'info',
                        title: 'Passwords doesn`t match',
                        // text: 'Your current password doesnt match our records',
                        confirmButtonText: 'Try again',
                        confirmButtonColor: '#FF7F00'
                    })
                </script>
                <?php } else {
                // update password
                $sql_update_pass = "UPDATE usertbl SET password = '$new_pass' WHERE userID = '$id';";
                ...
                if ($res_update_pass) { ?>
                    <script>
                        Swal.fire({
                            ...
                            text: 'Your password is succesfully updated!',
                        ...
                        <div class="col-md-9">
                            <div class="message-box box-shadow white-bg">
                                <form id="contact-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="blog-section-title border-left mb-30">Change Password</h4>
                                            <p>For your accounts security, regularly change your password</p>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <button class="submit-btn-1 mt-1 btn-hover-1 f-right" type="submit" name="update_password">Change Password</button></div>
                                    </div>
                                </form>
